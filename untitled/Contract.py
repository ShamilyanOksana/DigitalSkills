...
class Library:
    ...
    contract_address = web3.Web3.toChecksumAddress("0xa8e004fa7721dd6240a8a9129d8483603fe16302")
    ...
    def __init__(self):
        self.w3 = web3.Web3(web3.HTTPProvider('http://192.168.1.17:8545'))
    ...
    def get_file(self, file_id):
        ...
        if data:
            ...
            if data.get('category') == 2:
                ...
                file_data = cry.aes_encode(data.get('data'), '123')
                print(file_data)
            ...
            if file_hash == my_file_hash:
                ...
                self.w3.eth.waitForTransactionReceipt(tx)
                self.w3.miner.stop()
                with open('C:\\Users\\user\\Desktop\\my_library\\' + file_name, 'wb') as file:
