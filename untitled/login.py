...
class Ui_Dialog(object):
    ...
    def authorization(self):
        ...
        if Proverka == True:
            if login == "0x331c59a41724c55ea5dcc24a1aaae463ffbf037a" and password == "123":
            ...
            #     self.Admin_Ui.setupUi(self.Admin_Window)
            #     self.Admin_Window.show()
            elif login == "0x2b2b2c5dc3a8aeb7fb76fbaf4e396498ff935f0b" and password == "123":
            ...
            #     self.User_Ui.setupUi(self.Window)
            #     self.Window.show()
            elif login == "0x4662a94a760ec2d633a7232bff020f7d7b494916" and password == "123":
                self.User_Ui.Estate.auth_geth("0x4662a94a760ec2d633a7232bff020f7d7b494916", "123")
